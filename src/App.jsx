            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={s.name}
                  className="h-11 w-11 rounded-full border border-[#C41E3A]/30 flex items-center justify-center text-[#a5bdbc] hover:border-[#C41E3A] hover:bg-[#C41E3A] hover:text-white transition-all duration-300"
                >
                  {s.svg}
                </a>
              ))}
